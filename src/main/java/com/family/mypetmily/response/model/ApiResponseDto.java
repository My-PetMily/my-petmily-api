...
@Getter
@Setter
@ApiModel(value = "공통 Response", description = "모든 API의 공통적인 응답 명세")
public class ApiResponseDto {
	 ...
	 */
	@ApiModelProperty(value = "요청에 대한 정보\n어떤 요청 결과 값이든 참조 할 수 있도록 Object 타입으로 정의", example = "{\n\t\t\"token\": \"잘못 보낸 토큰 정보\"\n\t}")
	private Object result;

	public ApiResponseDto(String code, String message, Object result) {
